...
const CallUs = () => {
  return (
    <div className='w-full h-auto'>
      <div className="relative w-full h-auto min-h-[20vh] bg-slate-700 shadow-xl
      shadow-black/50 flex">
        ...
        />
        <div className="text-center py-8 md:py-16 flex flex-col md:flex-row justify-evenly items-center w-full">
